        ...
        <div className="numbers-buyed-box">
            <div className="numbers-buyed-box__wrapper">
                ...
                <div className="numbers-buyed-box__wrapper__infos-box">
                    <h3 className="numbers-buyed-box__wrapper__infos-box__name">{name}</h3>

                    <div className="numbers-buyed-box__wrapper__infos-box__numbers-box">
                        {numbers?.map((number, index) => (
                            <span key={`number-${index}`} className="numbers-buyed-box__wrapper__infos-box__numbers-box__number">
                                {number}
                            </span>
                        ))}
                    </div>
            ...
            <div className="numbers-buyed-box__prize-image-box">
                <img
                    src={
                        raffleImage?.data
                            ? `data:${raffleImage.contentType};base64,${_arrayBufferToBase64(raffleImage.data.data)}`
                            : prize2
                    }
                    alt="Prêmio"
                    className="numbers-buyed-box__prize-image-box__image"
                />
            </div>
        </div>
    );
