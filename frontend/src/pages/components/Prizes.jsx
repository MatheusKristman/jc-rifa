    ...
    return (
        <div className="prizes">
            ...
            <div className="prizes__infos-box">
                <h3 className="prizes__infos-box__title">{title}</h3>

                <span className="prizes__infos-box__desc">{subtitle}</span>

                <span
                    className={
                        winner
                            ? "prizes__infos-box__status finished"
                            : progress <= 50
                            ? "prizes__infos-box__status new"
                            : "prizes__infos-box__status finishing"
                    }
                >
