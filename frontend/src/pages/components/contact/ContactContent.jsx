  ...
  useEffect(() => {
    const sendMessage = () => {
      ...
      window.location.assign(
        `${import.meta.env.VITE_WHATSAPP_BASE_API}&text=${message}`,
      );
    };
          ...
          <div className="contact__contact-content__container__form__inputs-wrapper">
            ...
            >
              ...
              <input
                ...
                style={
                  error.name ? { border: "2px solid rgb(209, 52, 52)" } : {}
                }
            ...
            >
              ...
              <select
                ...
                style={
                  error.raffle ? { border: "2px solid rgb(209, 52, 52)" } : {}
                }
