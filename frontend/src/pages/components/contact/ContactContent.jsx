...
const ContactContent = () => {
    const { isFaqOpen1, isFaqOpen2, isFaqOpen3, openFaq1, openFaq2, openFaq3, closeFaq1, closeFaq2, closeFaq3 } = useHomeFaqStore(
        (state) => ({
        ...
        <div className="contact__contact-content">
            <div className="contact__contact-content__container">
                ...
                <div className="contact__contact-content__container__contact-title-wrapper">
                    <h1 className="contact__contact-content__container__contact-title-wrapper__title">✉️ Contato</h1>

                    <span className="contact__contact-content__container__contact-title-wrapper__desc">Tire suas dúvidas.</span>
                </div>
                ...
                <form className="contact__contact-content__container__form">
                    <div className="contact__contact-content__container__form__inputs-wrapper">
                        <label htmlFor="name" className="contact__contact-content__container__form__inputs-wrapper__label">
                            Nome
                            <input
                                type="text"
                                name="name"
                        ...
                        <label htmlFor="tel" className="contact__contact-content__container__form__inputs-wrapper__label">
                            Telefone
                            <input
                                type="text"
                                name="tel"
                        ...
                        <label htmlFor="raffle" className="contact__contact-content__container__form__inputs-wrapper__label">
                            Sorteio
                            <select
                                name="raffle"
                                id="raffle"
                        ...
                        <label htmlFor="subject" className="contact__contact-content__container__form__inputs-wrapper__label">
                            Assunto
                            <select
                                name="subject"
                                id="subject"
                        ...
                        <label htmlFor="message" className="contact__contact-content__container__form__inputs-wrapper__label">
                            Mensagem
                            <textarea
                                name="message"
                                id="message"
