...
export default function PaymentModal() {
    const { closePaymentModal, qrCodePayment, paymentLink } = useBuyNumbersStore((state) => ({
    ...
    const handleClosePaymentModal = () => {
        paymentOverlayRef.current.style.animation = "paymentFadeOut 0.2s ease forwards";
        paymentBoxRef.current.style.animation = "paymentModalOut 0.4s ease forwards";
    ...
    return (
        <div ref={paymentOverlayRef} className="raffle-selected__raffle-selected-content__container__payment-overlay">
            <div
                ref={paymentBoxRef}
