...
const useRaffleStore = create((set) => ({
  ...
  winnerImageUrl: "",
  setWinnerImageUrl: (url) => set(() => ({ winnerImageUrl: url })),
  ...
  isDeletingWinner: false,
  setToDeleteWinner: () => set(() => ({ isDeletingWinner: true })),
  setNotToDeleteWinner: () => set(() => ({ isDeletingWinner: false })),
